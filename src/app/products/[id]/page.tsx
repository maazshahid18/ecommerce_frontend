...
const fetchedProduct: Product = {
  ...
  const handleAddToCart = () => {
    if (product && selectedVariant && quantity > 0) {
      ...
      alert(`${item.quantity} of ${item.productName} (${item.selectedVariantValue}) added to cart!`);
    } else {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-slate-600 font-medium">Loading product details...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <div className="relative w-32">
                  ...
                  >
                    {[...Array(product.inventory > 10 ? 10 : product.inventory)].map((_, i) => (
              ...
              <div className="flex items-center space-x-2">
                <div className={`w-3 h-3 rounded-full ${product.inventory > 0 ? 'bg-green-500' : 'bg-red-500'}`}></div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                <div className="flex flex-col items-center space-y-2">
                  <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8-4v10m0 0v4" />
                  </svg>
                ...
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <span className="text-sm font-medium text-slate-600">Quality Guaranteed</span>
                </div>
                <div className="flex flex-col items-center space-y-2">
                  <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                  <span className="text-sm font-medium text-slate-600">30-Day Returns</span>
                </div>
              </div>
            </div>
          </div>
